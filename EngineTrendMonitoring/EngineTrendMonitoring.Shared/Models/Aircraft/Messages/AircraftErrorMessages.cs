namespace EngineTrendMonitoring.Shared.Models.Aircraft.Messages
{
    public class AircraftErrorMessages
    {
        ...
        public const string AIRCRAFT_X_HAS_NOT_BEEN_FOUND = "Aircraft {0} has not been found";
        public const string AIRCRAFT_X_IS_ALREADY_INACTIVE = "Aircraft {0} is already inactive";
    }
}
